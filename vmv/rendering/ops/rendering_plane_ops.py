...
def add_background_plane_for_side_camera(bounding_box):
    ...
    # Simply add the plane of the front camera and rotate it around the Y axis
    plane = add_background_plane_for_front_camera(bounding_box=bounding_box)

    # Apply the rotation
    vmv.scene.rotate_object(scene_object=plane, x=0, y=1.5708, z=0)
