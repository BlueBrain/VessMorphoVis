...
class Meshing:
    ...
    class Rendering:
        ...
        class View:
            ...
            # Front view
            FRONT_VIEW = 'RENDERING_MESH_FRONT_VIEW'

            # Side view
            SIDE_VIEW = 'RENDERING_MESH_SIDE_VIEW'

            # Top view
            TOP_VIEW = 'RENDERING_MESH_TOP_VIEW'
            ...
            def get_enum(argument):
                ...
                # Front view
                if argument == 'front':
                    return Meshing.Rendering.View.FRONT_VIEW

                # Side view
                elif argument == 'side':
                    return Meshing.Rendering.View.SIDE_VIEW

                # Top view
                elif argument == 'top':
                    return Meshing.Rendering.View.TOP_VIEW
