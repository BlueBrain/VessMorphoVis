...
def create_uv_sphere(radius=1, 
    ...
    vmv.scene.ops.deselect_all()
    vmv.scene.ops.select_object_by_name(sphere)
    ...
    if color is not None:
        sphere_material = vmv.shading.create_lambert_ward_material(name='sphere_color', color=color)
        vmv.shading.set_material_to_object(sphere, sphere_material)
