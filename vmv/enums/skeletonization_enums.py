...
class Skeletonization:
    ...
    class Rendering:
        ...
        class View:
            ...
            # Front view
            FRONT_VIEW = 'RENDERING_MORPHOLOGY_FRONT_VIEW'

            # Side view
            SIDE_VIEW = 'RENDERING_MORPHOLOGY_SIDE_VIEW'

            # Top view
            TOP_VIEW = 'RENDERING_MORPHOLOGY_TOP_VIEW'
            ...
            def get_enum(argument):
                ...
                # Front view
                if argument == 'front':
                    return Skeletonization.Rendering.View.FRONT_VIEW

                # Side view
                elif argument == 'side':
                    return Skeletonization.Rendering.View.SIDE_VIEW

                # Top view
                elif argument == 'top':
                    return Skeletonization.Rendering.View.TOP_VIEW
