...
####################################################################################################
# @ProxySkeletonBuilder
####################################################################################################
class ProxySkeletonBuilder:
    ...
    def construct_proxy_section(self, bmesh_skeleton, section):
        pass



    def build_proxy_skeleton(self):

        # create the bmesh

        # for each section in the skeleton, construct a line and add it to the bmesh skeleton

        # update the bmesh

        # link the bmesh to the scene and see the performance
